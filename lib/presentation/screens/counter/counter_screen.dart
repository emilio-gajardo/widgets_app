  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          /// [actualizar el valor de una variable emitida por un provider riverpod]
          ref.read(counterProvider.notifier).state++; // forma 1
          //ref.read(counterProvider.notifier).update((state) => state++);// forma 2
        },
      ),
    );
  }
